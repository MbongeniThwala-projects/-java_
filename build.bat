...
rem set PATH=%PATH%;"C:\Users\tebza\Desktop\University\All Computer Science\Computer Science 2022\JDK\bin"
REM Paths for JavaFX
set USE_JAVAFX=true
rem set JAVAFX_HOME=C:\javafx-17
set PATH=%PATH%;"C:\Users\tebza\Desktop\University\All Computer Science\Computer Science 2022\JDK\bin"
set JAVAFX_HOME="C:\Users\tebza\Desktop\University\All Computer Science\javaFX\javafx-sdk-17.0.2"
rem set PATH=%PATH%;"C:\Users\tebza\Desktop\University\All Computer Science\Computer Science 2022\JDK\bin"
...
javac %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -cp %PRAC_BIN%;%PRAC_LIB% -d %PRAC_BIN% %PRAC_SRC%\csc2b\client\Client.java
IF /I "%ERRORLEVEL%" NEQ "0" (
...
javadoc %JAVAFX_ARGS% -sourcepath %PRAC_SRC% -classpath %PRAC_BIN%;%PRAC_LIB% -use -version -author -d %PRAC_DOCS%\%PRAC_JDOC% -subpackages csc2b.client
IF /I "%ERRORLEVEL%" NEQ "0" (
...
java %JAVAFX_ARGS% -cp %PRAC_BIN%;%PRAC_LIB% csc2b.client.Client
IF /I "%ERRORLEVEL%" NEQ "0" (
